...
@section('konten')
    <section class="container-fluid p-4">
        ...
        {{-- table sudah responsive --}}
        @if ($data_barang->count())
            <article class="d-flex overflow-hidden flex-column rounded-top my-3 bg-white ">
                                ...
                                <tr>
                                    ...
                                    <td class="pb-0 pt-3 d-flex  justify-content-evenly gap-md-2 mx-auto">
                                        <button class="btn btn-sm btn-orange px-lg-4 text-center rounded-2 fw-medium"
                                            ...
                                            data-id="{{ $data_brg->id }}" data-barang="{{ json_encode($data_brg) }}"
                                        ...
                                        <button class="btn btn-sm btn-red px-lg-3 text-center rounded-2 fw-medium"
                                            ...
                                            data-bs-target="#deleteBarangModal" data-id="{{ $data_brg->id }}">
                ...
                <div class="d-flex justify-content-between  m-4 mt-5">
                    <div class="">
                        <button class="btn btn-outline-success" disabled>Halaman {{ $data_barang->currentPage() }}</button>
                    </div>
                    {{ $data_barang->appends(request()->except('page'))->links() }}
                </div>
            </article>
    </section>
@else
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body m-3 mt-0 pt-0 pb-3">
                    <form method="POST" id="tambahForm" action="{{ url('admin/dataBarang/store') }}">
                        @csrf
                        <div class="mb-4">
    ...
    {{-- Modal Edit Barang --}}
    @foreach ($data_barang as $data_brg)
        <div class="modal fade" id="editBarangModal" tabindex="-1" aria-labelledby="editModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header border-bottom-0 m-3 py-0 ">
                    ...
                    <div class="modal-body m-3 mt-0 pt-0 pb-3">
                        <form id="updateForm" method="post" action="{{ route('barangs.update', $data_brg->id) }}">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('kd_produk') }}" readonly required>
                                @error('kd_produk')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="d-flex row gap-4 justify-content-between mb-4">
                                <div class=" col-lg-3 col-md-12 ">
                                    <label for="ukuran" class="form-label label-order mb-1">Ukuran</label>
                                    <select class="form-select form-select-lg  shadow" id="ukuran" required>
                                        <option selected>Pilih Ukuran</option>
                                ...
                                <div class=" col-lg-3 col-md-12 ">
                                    ...
                                    <input type="number"
                                        ...
                                        id="edit-harga" name="harga_satuan" value="{{ old('harga_satuan') }}" required>
                                    @error('harga_satuan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class=" col-lg-3 col-md-12 ">
                                    ...
                                    <input type="number"
                                        ...
                                        id="edit-stok" name="stock" value="{{ old('stock') }}" required>
                                    @error('stock')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-5 col-lg-3">
                                ...
                                <input type="number"
                                    ...
                                    id="edit-point_produk" name="point" value="{{ old('point') }}" required>
                                @error('point')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="d-flex gap-4 justify-content-md-between ">
                                ...
                                <button type="button" class="btn btn-blue px-5 py-2"
                                    onclick="editBarang()">Simpan</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <!-- Modal Delete -->
        <div class="modal fade" id="deleteBarangModal" tabindex="-1" role="dialog">
                    ...
                    <div class="my-5">
                        ...
                        <div class="d-flex justify-content-center gap-3">
                            <form id="deleteForm" method="post" class="d-inline">
                                ...
                                @if ($data_barang->count())
                                    {{-- Add this line --}}
                                    <button type="button" class="btn btn-blue" id="btn-ya"
                                        data-id="{{ $data_brg->id }}" onclick="hapusBarang()">Ya</button>
                                @endif
                            </form>
    ...
    <script>
        ...
        function tambahBarang() {
            ...
            //
            // var nama = $('#nama').val();
            // var kdProduk = $('#kd-produk').val();
            // var ukuran = $('#ukuran').val();
            // var harga = $('#harga').val();
            // var stok = $('#stok').val();
            // var video = $('#video').val();
            // var point = $('#point_produk').val();
