    ...
    <div class="container-fluid p-4">
            ...
            <div class="col-xl-9  col-lg-10 col-md-11 mb-2 mt-5 bg-white border rounded">
                <div class="d-flex justify-content-start align-items-center">
                    ...
                    <div class="col p-0 text-start my-3 px-3">
                        <p class="mb-1 h5  text-capitalize" style="font-size: 28px; color:#41404C;">Yusuf bin Titan</p>
                        <p class="mb-0 fw-light" style="font-size: 22px;  color:#5C6B82;">ID12345678</p>
                        <p class="mb-0 fs-6" style=" color:#5C6B82;"><span class="fs-6" style="color:#41404C; white-space:pre;">Hp 1       : </span>082212345678</p>
                        <p class="mb-0 fs-6" style=" color:#5C6B82;"><span class="fs-6" style="color:#41404C; white-space:pre;">Hp 2      : </span>082212345678</p>
                        <p class="mb-0 fs-6" style=" color:#5C6B82; white-space:nowrap;"><span class="fs-6" style="color:#41404C; white-space:pre;">Email    : </span>sesuatu@gmail.com</p>
                    </div>
                    <div class="col text-start align-self-start mt-3 px-3"style="max-width: 230px;">
                        <p class="mb-0 fs-4 " >Tgl. bergabung</p>
                        <p class="my-2" style="font-size: 22px; font-weight:300; color:#666666;">3/04/2016</p>
                        <span>
                            ...
                            <p class="m-0 d-inline fw-semibold" style="color:#D8CF06;" >129</p>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-center bg-white" >
            <div class="col-lg-10 col-xl-9 col-md-11  bg-white border rounded mt-2 mb-4 ">
                <div class="mt-3 mb-4">
                    <span>
                        <a href="/admin/detail" class="text-decoration-none ">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body mx-3 pt-0 ">
                    <div class="text-center mx-5">
                        <small class="text-danger">Setiap kelipatan Rp.100,000 daru transkasi mendapatkan 10 point !</small >
                    </div>
                    <div class="input-modal mt-2">
                        <label for="point" class="fw-medium">Point</label>
                        <input type="number" class="form-control shadow" id="point">
                    </div>
                </div>
                <div class="modal-footer border-top-0  justify-content-center ">
                    <button type="button" class="btn btn-blue px-3 py-2" data-bs-dismiss="modal">Simpan</button>  
                </div>   
            </div>
        </div>
    </div>
