...
@section('konten')
    <div class="container-fluid p-4">
            ...
            <div class="col-xl-9  col-lg-10 col-md-11 mb-2 mt-5 bg-white border rounded">
                <div class="d-flex justify-content-start align-items-center">
                    ...
                    <div class="col p-0 text-start my-3 px-3">
                        ...
                        <p class="mb-0 fs-6" style=" color:#5C6B82;"><span class="fs-6" style="color:#41404C; white-space:pre;">Hp 1       : </span> 089912345678</p>{{-- spasi sengaja  --}}
                        <p class="mb-0 fs-6" style=" color:#5C6B82;"><span class="fs-6" style="color:#41404C; white-space:pre;">Hp 2      : </span>  087712345678</p>{{-- ganti dengan data tanpa hapus spasi yang ada --}}
        ...
        <div class="d-flex justify-content-center bg-white" >
            <div class=" d-flex  gap-4 flex-column col-xl-9 col-lg-10 col-md-11 bg-white border rounded mt-2 p-4">
                <div class="d-flex gap-4 align-items-center ">
                    <a class="text-decoration-none " href="/admin/dataPelanggan"><i class="fa-solid fa-arrow-left fs-4 color-title mb-0"></i></a><span class=" h4 color-title mb-0">Detail pelanggan</span>
                </div>
        ...
        <div class="d-flex justify-content-center bg-white ">
            <a class="btn btn-blue my-4 px-4 py-2 " href="/admin/riwayat">Riwayat Transaksi</a>
        </div> 
    </div>
