                ...
                <div class="modal-content">
                    <div class="modal-header m-4 p-0  d-flex justify-content-between align-items-start border-bottom-0 ">
                        <div class="flex-fill  col-xl-3 d-flex justify-content-start p-0">
                            <div class="idProduct ">
                                <p class="text-uppercase px-2 py-3"  style="font-family: Montserrat;">#az019210djd12</p>
                            </div>
                        </div>
                        <div class="flex-fill  col-xl-2  flex-column p-0">
                            <div class="headReq">  
                                <p class="text-capitalize" style="font-family: Montserrat;margin-bottom:12px;">22 November 2021</p>
                                <p class="text-capitalize " style="font-family: Montserrat;">limited shoping</p>
                            </div>
                        </div>
...
3. Alamat = 01/01, Perumahan Asri Indah, 14, Desa/Kelurahan
                        ...
                        <div class="d-flex gap-3 justify-content-end p-0 m-0">
                            ...
                            <a href="/admin/editRequest" class="btn btn-blue border-0  py-2 px-5" style="font-size:18px;" onclick="handleAccept()">Diterima</a>
                        </div>
                    </div>
                </div>
            </div>
