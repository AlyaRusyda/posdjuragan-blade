...
@section('konten')
    <section class="container-data_notif rounded max-container ">
        {{-- Header Profile --}}
        <article class="header-data_notif d-flex flex-column align-items-start flex-lg-row justify-content-lg-between align-items-lg-center mx-5 my-4">
                <div class="align-items-center ">
                    <h1 class="fw-bold m-0 px-0 header-text">{{ $title }}</h1>
                </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable w-100 ">
                    <div class="modal-content">
                        ...
                        <div class="modal-body px-5">
                            <form action="" id="formDataNotif">
                                <div class="mb-3">
                                    <label for="teks" class="form-label fw-semibold d-flex gap-3"><img
                                            src="/assets/icons/Teks.png" width="32" /> Teks Tampilan <span
                                            class="text-danger">*</span></label>
                                    <textarea type="text" class="form-control border border-black rounded-0" id="teks" required></textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select border border-black rounded-0" id="status" required>
                                ...
                                <div class="mb-1">
                                    <label for="audio" class="form-label fw-semibold d-flex gap-3"><img
                                            ...
                                            class="text-danger">*</span></label>
                                    <input type="file" class="form-control border border-black rounded-0" id="audio"
                                        accept=".mp3" required>
                                    <div class="invalid-feedback">
                        ...
                        <div class="mx-auto d-flex mb-2">
                            <button type="button" class="btn w-100 mb-3 me-5 fw-semibold btn-cancel px-5"
                                data-bs-dismiss="modal">Batal</button>
                            <button type="submit" class="btn btn-primary w-100 mb-3 fw-semibold btn-add px-5"
                                id="simpan" data-bs-target="#actionModalTambah" data-bs-toggle="modal"
                    ...
                    <div class="modal-content">
                        <div class=" my-5 d-flex flex-column justify-content-center ">
                            <img src="{{ asset('assets/img/sukses.png') }}" alt="" width="100px"
                                class="mx-auto mb-2">
                            <small class="fw-bolder text-center ">Data notif <span class="text-success ">Berhasil</span>
                                Ditambahkan!</small>
                        </div>
                    </div>
                </div>
                            ...
                            <form action="" id="editForm">
                                <div class="mb-3">
                                    <label for="editTeks" class="form-label fw-semibold d-flex gap-3"><img
                                            src="/assets/icons/Teks.png" width="32" /> Teks Tampilan <span
                                            class="text-danger">*</span></label>
                                    <textarea type="text" class="form-control border border-black rounded-0" id="editTeks" name="teks" required></textarea>
                                    <div class="invalid-feedback">
                                        Masukkan Teks Tampilan
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="file" class="form-control border border-black rounded-0"
                                        id="editAudio" accept=".mp3" name="audio" required>
                                    <div class="invalid-feedback">
                                        Masukkan File Audio (.mp3)
                                    </div>
                                </div>
                    ...
                    <div class="modal-content">
                        <div class=" my-5 d-flex flex-column justify-content-center ">
                            ...
                            <div class="mx-auto d-flex gap-2">
                                <button type="button" class="btn mb-3 btn-primary px-5" data-bs-dismiss="modal"
                                    data-bs-target="#actionModalHapus" data-bs-toggle="modal">Ya</button>
                                <button type="submit" class="btn btn-danger mb-3 px-5" id="simpan"
                                    data-bs-dismiss="modal">Batal</button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal fade" id="errorModalHapus" tabindex="-1" role="dialog"
                ...
                <div class="tambah-cari-notif d-flex flex-column align-items-start gap-3 flex-sm-row mt-4 mt-lg-0">
                    <button
                        ...
                        <div class="position-relative custom-shadow">
                            <input type="text" name="search" class="px-4 py-2 w-auto" id="searchInput" placeholder="Cari Teks" value="{{ $search }}">
                            <span class="position-absolute top-50 end-0 translate-middle-y pe-4"><i class="fa-solid fa-magnifying-glass text-muted"></i></span>
                        </div>
                </div>
        </article>
                ...
                <table class="rounded-2 bg-white tabel">
                    ...
                    <tbody class="text-center">
                        @foreach ($data_notif as $cs)
                            <tr class="row-notif" style="margin-bottom: 10px;">
                                <td data-header="No" scope="row">{{ $cs['id'] }}</td>
                                <td data-header="Tampilan Teks" class="text-capitalize flex-wrap ">{{ $cs['teks'] }}</td>
                                <td data-header="File Audio" class="ps-md-5">{{ $cs['audio'] }}</td>
                                <td data-header="Status" class="status">
                                    @if ($cs['status'] === 'active')
                                        <p class="status-active text-uppercase text-white fw-semibold rounded-5 my-auto m-md-auto text-center ">
                                            {{ $cs['status'] }}</p>
                                    @elseif ($cs['status'] === 'non_active')
                                        <p class="status-non text-uppercase text-white fw-semibold rounded-5 my-auto m-md-auto text-center ">
                                            non-active</p>
                                    @endif
                                </td>
                                <td data-header="Opsi" class="opsi d-flex align-items-center justify-content-between gap-2">
