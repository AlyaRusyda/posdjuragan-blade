...
@section('konten')
    <div class="container-fluid p-4">
        ...
        <div class="d-flex justify-content-center" style="background-color: #202B46;">
            <div class="col-xl-9  col-lg-10 col-md-11  {{ $pelanggan->alamat }} mb-2 mt-5 bg-white border rounded">
                <div class="d-flex justify-content-start align-items-center">
                    ...
                    <div class="col p-0 text-start my-3 px-3">
                        <p class="mb-1 h5  text-capitalize" style="font-size: 28px; color:#41404C;">{{ $pelanggan->namaPelanggan }}</p>
                        <p class="mb-0 fw-light" style="font-size: 22px;  color:#5C6B82;">ID{{ $pelanggan->id }}</p>
                        <p class="mb-0 fs-6" style=" color:#5C6B82;"><span class="fs-6" style="color:#41404C; white-space:pre;">Hp 1       : </span>  {{ $pelanggan->hp }}</p>
                        <p class="mb-0 fs-6" style=" color:#5C6B82;"><span class="fs-6" style="color:#41404C; white-space:pre;">Hp 2      : </span>  {{ $pelanggan->hp2 }}</p>
                        <p class="mb-0 fs-6" style=" color:#5C6B82; white-space:nowrap;"><span class="fs-6" style="color:#41404C; white-space:pre;">Email    : </span>  {{ $pelanggan->email }}</p>
                    </div>
                    <div class="col text-start align-self-start mt-3 px-3"style="max-width: 230px;">
                       <p class="mb-0 fs-4 " >Tgl. bergabung</p>
                       <p class="my-2" style="font-size: 22px; font-weight:300; color:#666666;">{{ $pelanggan->tanggalRegistrasi = date('d/m/y') }}</p>
                       <span>
        ...
        <div class="d-flex justify-content-center bg-white" >
            <div class=" d-flex  gap-4 flex-column col-xl-9 col-lg-10 col-md-11 bg-white border rounded mt-2 p-4">
                <div class="d-flex gap-4 align-items-center ">
                    ...
                    <span class=" h4 color-title mb-0">Detail pelanggan</span>
                </div>
                <div class="d-flex flex-row justify-content-center px-lg-4 px-md-0 ">
                    ...
                    <div class="col-6">
                        <div class="d-flex flex-row mb-4">
                            <div class="col-6 px-2">
                                ...
                                <p class="fs-5 fw-light text-wrap mb-0">{{ $pelanggan->provinsi }}</p>
                            </div>
                            <div class="col-6 px-2">
                                <p class="mb-2 color-title h4" >Kab/Kota</p>
                                <p class="fs-5 fw-light text-wrap mb-0">{{ $pelanggan->kabupaten }}</p>
                            </div>
                        </div>
                        <div class="d-flex flex-row mb-4">
                            <div class="col-6 px-2">
                                <p class="mb-2 color-title h4">Kecamatan</p>
                                <p class="fs-5 fw-light text-wrap mb-0">{{ $pelanggan->kecamatan }}</p>
                            </div>
                            <div class="col-6 px-2">
                                <p class="mb-2 color-title h4">Kode Pos</p>
                                <p class="fs-5 fw-light text-wrap mb-0">{{ $pelanggan->kodepos }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6 px-2">
                        ...
                        <p class="fs-5 fw-light text-wrap mb-0">{{ $pelanggan->alamat }}</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="d-flex justify-content-center bg-white ">
            <a class="btn btn-blue my-4 px-4 py-2 " href="/cs/riwayat">Riwayat Transaksi</a>
        </div> 
