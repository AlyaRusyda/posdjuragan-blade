    ...
    <div class="container-fluid p-4">
        <div class="bg-white ">
           ...
           <div class="d-flex justify-content-center bg-white" >
               ...
               <div class="col-lg-10 col-xl-9 col-md-10  bg-white border rounded mt-2 mb-4  ">
                    <div class="mt-3 mb-4">
                        <span><i class="fa-solid fa-arrow-left ms-4 h4 color-title"></i></span><p class="d-inline ms-4 h4 color-title">Riwayat Transaksi</p>
                    </div>
                    ...
                    <div class="d-flex flex-column m-3 gap-3">
                        <div class="d-flex justify-content-between " style="border: none; border-radius: 10px; background-color: #F3F1FC; ">
                            ...
                            <div class="d-flex align-items-center justify-content-center gap-3 mx-4">
                                <a  href="/invoice"class="btn btn-purple" style="font-size: 12px;">Lihat Invoice</a>
                            </div>
                        </div>
