                    ...
                    <form action="" class="form-container">
                        ...
                        @foreach ($orderan as $data)
                            <div id="maincard" class="card mt-5 rounded-3 custom-input">
                                <!--atas-->
                                <div class="card-header d-flex dashed-line justify-content-between">
                                    <!--kiri-->
                                   <div class="card-atas-kiri d-flex flex-row " style="box-sizing: border-box;">
                                    ...
                                    <!--kanan-->
                                    <div class="kanan ">
                                        {{-- tampilan timeline jika belum terbayar atau terbayar 0 rupiah --}}
                                        {{-- @if ($data->paid_mount == 0)
                                            <div class="mt-3" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                ...
                                                <svg style="" class="ikon-satu" width="48" height="63"
                                                    viewBox="0 0 48 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                        ...
                                        {{-- tampilan timeline apabila sudah terbayar lunas dan statusnya dalam pemrosesan --}}
                                        ...
                                        {{-- tampilan timeline apabila terbayar namun kurang, dan statusnya masih dalam_proses --}}
                                        {{-- @if ($data->paid_mount > 0 && $data->status == 'dalam_proses' && $data->total_amount != $data->paid_mount)
                                            <div class="mt-3 d-flex ">
                                                <div data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                    data-bs-title="Pesanan ditambahkan"
                                                    data-bs-custom-class="custom-tooltip">
                                                    <svg class="ikon-satu" width="48" height="63"
                                                        ...
                                                        <path
                                                            d="M28.7447 20.482H24.7887V24.4381C24.7887 24.6479 24.7053 24.8491 24.5569 24.9975C24.4085 25.1459 24.2073 25.2293 23.9974 25.2293C23.7876 25.2293 23.5864 25.1459 23.438 24.9975C23.2896 24.8491 23.2062 24.6479 23.2062 24.4381V20.482H19.2502C19.0404 20.482 18.8391 20.3987 18.6907 20.2503C18.5423 20.1019 18.459 19.9006 18.459 19.6908C18.459 19.481 18.5423 19.2797 18.6907 19.1313C18.8391 18.983 19.0404 18.8996 19.2502 18.8996H23.2062V14.9436C23.2062 14.7337 23.2896 14.5325 23.438 14.3841C23.5864 14.2357 23.7876 14.1523 23.9974 14.1523C24.2073 14.1523 24.4085 14.2357 24.5569 14.3841C24.7053 14.5325 24.7887 14.7337 24.7887 14.9436V18.8996H28.7447C28.9545 18.8996 29.1558 18.983 29.3042 19.1313C29.4525 19.2797 29.5359 19.481 29.5359 19.6908C29.5359 19.9006 29.4525 20.1019 29.3042 20.2503C29.1558 20.3987 28.9545 20.482 28.7447 20.482Z"
                                                            fill="#24A240" />
                                                        <circle cx="23.9977" cy="19.6911" r="13.5385"
                                                            stroke="#24A240" stroke-width="2.46154" />
                                                        <circle cx="23.9991" cy="43.6905" r="4.30769"
                                                            fill="#24A240" />
                                                        <line x1="20.3086" y1="43.6911" x2="48.0009"
                                                ...
                                                <div data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                    data-bs-title="Dibayar sebagian"
                                                    data-bs-custom-class="custom-tooltip">
                                                    <svg class="ikon-satu" width="48" height="63"
                                                        viewBox="0 0 48 63" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <path
                                                            ...
                                                            fill="#D8CF06" />
                                                        <circle cx="23.9991" cy="44.1124" r="4.30769"
                                                            fill="#D8CF06" />
                                                        <line x1="20.3086" y1="44.113" x2="48.0009"
                                                            y2="44.113" stroke="#D8CF06" stroke-width="2.46154" />
                                                        <line y1="44.113" x2="27.6923" y2="44.115"
                                                            stroke="#D8CF06" stroke-width="2.46154" />
                                                        <path
                                ...
                                <div class="card-body d-flex   row gap-0 justify-content-evenly">
                                        ...
                                        <div class="card-body">
                                            <div class="mb-2">
                                                ...
                                                <input
                                                    ...
                                                    type="text" class="form-control fzt7" id="pemesan" readonly
                                            ...
                                            {{-- tombol pembayaran muncul apabila status masih dalam_proses dan jumalh yang terbayar masih kurang --}}
                                            @if ($data->total_amount != $data->paid_mount && $data->status == 'dalam_proses')
                                            ...
                                            {{-- tombol pembayaran tidak bisa di klik apabila sudah terbayar lunas dan statusnya dalam_proses --}}
                                            @if ($data->total_amount == $data->paid_mount && $data->status == 'dalam_proses')
                                                <button
                                                    class="rounded p-1 disabled-button justify-content-center flex-lg-row flex-md-column"
                                                    style="background-color: #202B46; color:white"
                                                    data-idpelanggan = "{{ $data->id_customer }}"><small
                                                        class="me-2  fzt6 col-12 text-center"><i
                                                            class="fa-regular fa-square-plus m-1"></i>Tambah
                                    ...
                                    <div class=" col-2 p-0 ">
                                        <div class="card-body" style="font-size: 15px">
                                            <p>Produk <i class="fa-solid fa-circle-info"></i></p>
                                            <div>
                                    ...
                                    <div class=" col-4 p-0">
                                        <div class="card rounded-3">
                                            {{-- header ketika pembayaran masih 0 --}}
                                            @if ($data->paid_mount == 0)
                                            ...
                                            {{-- header ketika sudah terbayar sebagian --}}
                                            @if ($data->paid_mount < $data->total_amount && $data->paid_mount > 0)
                                                <div class="card-header P-4 wajib-bayar custom-input"
                                            ...
                                            @if ($data->paid_mount == $data->total_amount)
                                                <div class="card-header P-4 wajib-bayar custom-input"
                                                ...
                                                <table class="table table-borderless fw-bold">
                                                    <tr>
                                                        ...
                                                        <td class=" fzt7" id="terbayar"
                                                            style="background-color: #EDEDED">RP
                                                            {{ number_format($data->paid_mount, 0, ',', '.') }}</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class=" fzt7" id="kekurangan"
                                                            style="background-color: #EDEDED">RP
                                                            {{ number_format(max(0, $data->total_amount - $data->paid_mount), 0, ',', '.') }}
                                                        </td>
                                                    </tr>
                                                </table>

                                                {{-- status lunas muncul apabila sudah terbayar lunas --}}
                                                @if ($data->total_amount == $data->paid_mount)
                                                    <div id="status-lunas"
                                    ...
                                    <div class=" col-3 p-0 ">
                                        <div class="card-body" style="font-size: 18px">
                                            <p style="font-weight: 900; color:#ccc" class=" fzt7">Keterangan</p>
                                            @php
