                                ...
                                <div class="card-body d-flex tablet-card  flex-row justify-content-evenly">
                                    ...
                                    <div class="col-3 p-0 ">
                                        <div class="card-body w-100 ">
                                            ...
                                            {{-- muncul status cek_pembayaran admin ketika status orderan cek_pembayaran --}}
                                            @if ($data->total_amount >= 0 && $data->status == 'cek_pembayaran')
                                                <div style="color:#ccc"
                                                    class="border w-100 fzt4 border-secondary fw-bold rounded-3 text-center p-2 mb-2 custom-input">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel" style="margin-left: 120px">Tambah
                                    Pembayaran</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <h6 class="text-center bg-warning mb-4 p-2 rounded">Detail Pembayaran tidak bisa diganti
                                    atau diubah</h6>
                                <form>
                                    <div class="d-flex">
                                        <div class="mb-3 me-3">
                                            ...
                                            <select class="form-select custom-input" aria-label="Default select example"
                                                id="tujuan-pembayaran" style="width: 200px">
                                        ...
                                        <div class="mb-3 ms-5">
                                            <label for="tanggal-bayar" class="col-form-label">Tanggal Bayar</label>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="mb-3 me-3 ms-3">
                                    ...
                                    <select class="form-select custom-input" name="status"
                                        aria-label="Default select example" id="opsi-orderan" style="width: 200px">
