        ...
        <article class="pt-4 d-flex justify-content-center align-items-center">
            <div class="mx-5 my-4 px-4 rounded-4 shadow border border-1 border-black bg-white w-100">
                    ...
                    <div class="col-lg-3 col-md-6 row pt-4">
                        ...
                        <div class="d-flex m-0 p-0 kd_produk">
                            ...
                            <ul
                                ...
                                <li class="color_text m-0 p-0">x {{ $order->quantity }}</li>
                                <li class="color_text m-0 p-0">x {{ $order->quantity }}</li>
                                <li class="color_text m-0 p-0">x {{ $order->quantity }}</li>
                                <li class="color_text m-0 p-0">x {{ $order->quantity }}</li>
                                <li class="pb-4 color_text">x {{ $order->quantity }}</li>
                            </ul>
                        </div>
                ...
                <div class="row my-3 d-flex align-items-center gap_btn">
                    <a href="{{ route('admin.data-pelanggan.invoice', ['orderNumber' => $order->order_number]) }}" class="d-flex justify-content-between align-items-center btn border-black color_text bg-white fs-6 fw-semibold col-lg-12 cetak_invoice pl-custom">
                        Cetak Invoice
