        ...
        <div class="head-reqEdit d-flex flex-column shadow p-4">
            <div class=" d-flex flex-row justify-content-between">
                <div class="idProduct px-2 py-3">
                    <p>Edit Orderan <span class="text-uppercase">#az019210djd12</span></p>
                </div>
                <div class="text-capitalize" style=" font-size:18px;">25 November 2021 (14:20:39)</div>
            </div>
            <div class="d-flex flex-column ">
                <div class="d-flex col-lg-12 py-3 px-0 justify-content-between ">
                    <p class="fs-4" style=" font-weight:600;">Request</p>
                </div>
                <div class="col-lg-12 p-0" style="white-space: pre-line;">1. Asal Orderan = Facebook
        ...
        <div class="body-reqEdit flex-column p-4 ">
            ...
            <div class="d-flex col-lg-5 flex-column mb-4">
                ...
                <div class="input-group rounded  bg-white shadow" id="data-pelanggan">
                    <input type="text" class="form-control m-1 text-capitalize " placeholder="Cari Pelanggan" id="pelanggan">
                    <div class="d-flex align-items-center mx-1">
                        <button class="btn btn-purple px-5 py-1 rounded" id="searchButton" data-bs-toggle="modal" data-bs-target="#modalSearch" type="button">Cari</button>
                    </div>
                </div>
            </div>
            ...
            <div  class="d-flex col-lg-8 flex-column mb-4" id="note-juragan">
                ...
                <textarea class="shadow form-control rounded text-muted " name="form-keterangan" id="note" rows="10" style="resize:none; white-space:pre-line;" >
                </textarea>
            </div>
            ...
            <div class="mb-2"><button type="button"  class="btn btn-blue py-2 px-5" onclick="saveOrder()" >Simpan</button></div>
...
<script>
    ...
    function saveOrder() {
        ...
        if (berhasil) {
            showSuksesModalEdit();
            setTimeout(function () {
                window.location.href = '/superAdmin/request';
            }, 1200);
        } else {
            showErorModalEdit();
            setTimeout(function () {
