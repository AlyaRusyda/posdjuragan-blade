...
@section('konten')
    <section class="container-edit_profile rounded">
        ...
        <article>
            <form class="bg-white py-5 body-edit_profile d-flex justify-center align-items-center">
                ...
                <div class="row py-4">
                    <div class="col-lg-12 row py-4 mx-0">
                        ...
                        <div class="col-lg-12 p-0 d-flex justify-content-between password-toggle gap-3">
                            <input class="w-100 m-0 px-3 py-lg-3 py-md-3 rounded border border-2 rounded" type="password"
            ...
            <a href="/superadmin/profile" class="btn btn_batal-edit">Batal</a>
