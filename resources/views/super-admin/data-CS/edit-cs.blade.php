                ...
                <form action="" class="needs-validation" novalidate>
                    ...
                    <div class="row mb-5">
                        <div class="col m-0 input-container">
                            ...
                            <input type="text" id="nama" class="form-control custom-input" value="CS Alda" required>
                    ...
                    <div class="row mb-5">
                        <div class="col m-0 input-container ">
                            ...
                            <input type="email" id="email" class="form-control custom-input" value="csalda@gmail.com"
                                required>
                            <div class="invalid-feedback fw-bold">
                                EROR: Field Tidak Boleh Kosong
                            </div>
                        ...
                        <div class="col m-0 d-flex flex-row gap-2 input-container ">
                            <div class="col">
                                ...
                                <input type="password" class="form-control custom-input rounded" id="password"
                                    value="csalda123" required>
                                <div class="invalid-feedback fw-bold">
                                    EROR: Field Tidak Boleh Kosong
                                </div>
                            </div>
                            ...
                            <ul style="width: 100%; border: 1px solid black;" class="dropdown-menu"
                                ...
                                <div class="row ms-1 me-1 mt-2 mb-2">
                                    <div class="col-md-6 d-grid gap-2">
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="RA" class="fw-bold p-2 ">RA</label>
                                            <div class="form-check me-3">
                                                <input type="checkbox" id="RA" value="RA">
                                            </div>
                                        </li>
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="fashion_lelaki" class="fw-bold p-2">Fashion Lelaki</label>
                                            <div class="form-check me-3 ">
                                                <input type="checkbox" id="fashion_lelaki" value="Fashion Lelaki">
                                            </div>
                                        </li>
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="blazer_jaket" class="fw-bold p-2">Blazer Jaket</label>
                                            <div class="form-check me-3 ">
                                                <input type="checkbox" id="blazer_jaket" value="Blazer Jaket">
                                            </div>
                                        </li>
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="jaket_korean" class="fw-bold p-2">Jaket Korean</label>
                                            <div class="form-check me-3 ">
                                                <input type="checkbox" id="jaket_korean" value="Jaket Korean">
                                            </div>
                                        </li>
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="korean_hunter" class="fw-bold p-2">Korean Hunter</label>
                                            <div class="form-check me-3 ">
                                                <input type="checkbox" id="korean_hunter" value="Korean Hunter">
                                            </div>
                                        </li>
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="limited_shopping" class="fw-bold p-2">Limited Shopping</label>
                                            <div class="form-check me-3 ">
                                                <input type="checkbox" id="limited_shopping" value="Limited Shopping">
                                            </div>
                                        </li>
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="fashion_cewek" class="fw-bold p-2">Fashion Cewek</label>
                                            <div class="form-check me-3 ">
                                                <input type="checkbox" id="fashion_cewek" value="Fashion Cewek">
                                            </div>
                                        </li>
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="juragan_jaket" class="fw-bold p-2">Juragan Jaket</label>
                                            <div class="form-check me-3 ">
                                                <input type="checkbox" id="fashion_cewek" value="Juragan Jaket">
                                            </div>
                                        </li>
                                    </div>
                                    <div class="col-md-6 d-grid gap-2">
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="seven_domu" class="fw-bold p-2">Seven Domu</label>
                                            <div class="form-check me-3 ">
                                                <input type="checkbox" id="seven_domu" value="Seven Domu">
                                            </div>
                                        </li>
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="indonesia_shop" class="fw-bold p-2">Indonesia Shop</label>
                                            <div class="form-check me-3 ">
                                                <input type="checkbox" id="indonesia_shop" value="Indonesia Shop">
                                            </div>
                                        </li>
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="no_rules" class="fw-bold p-2">No Rules</label>
                                            <div class="form-check me-3 ">
                                                <input type="checkbox" id="no_rules" value="No Rules">
                                            </div>
                                        </li>
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="joker" class="fw-bold p-2">Joker</label>
                                            <div class="form-check me-3 ">
                                                <input type="checkbox" id="joker" value="Joker">
                                            </div>
                                        </li>
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="say_cleo" class="fw-bold p-2">Say Cleo</label>
                                            <div class="form-check me-3 ">
                                                <input type="checkbox" id="say_cleo" value="Say Cleo">
                                            </div>
                                        </li>
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="distrokorea" class="fw-bold p-2">Distrokorea.com</label>
                                            <div class="form-check me-3 ">
                                                <input type="checkbox" id="distrokorea" value="Distrokorea.com">
                                            </div>
                                        </li>
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="jaket_anime" class="fw-bold p-2">Jaket Anime</label>
                                            <div class="form-check me-3 ">
                                                <input type="checkbox" id="jaket_anime" value="Jaket Anime">
                                            </div>
                                        </li>
                                        <li
                                            class="list-group-item border border-dark custom-checkbox d-flex justify-content-between align-items-center">
                                            <label for="reseller_nine" class="fw-bold p-2">Reseller Nine</label>
                                            <div class="form-check me-3 ">
                                                <input type="checkbox" id="reseller_nine" value="Reseller Nine">
                                            </div>
                                        </li>
                                    </div>
                                </div>
                    ...
                    <div class="d-flex flex-row gap-3 justify-content-end ">
                        <a href="/superadmin/data-cs" class="btn fw-bold px-4 py-2 btn-btl">Batal</a>
                        <button type="submit" class="btn fw-bold btn-dark px-4 py-2 btn-sv"
                            onclick="tambahCS()">Simpan</button>
                    </div>
                </form>
            </div>
