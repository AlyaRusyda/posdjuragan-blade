                            ...
                            <div id="maincard" class="card mt-5 rounded-3 custom-input">
                                ...
                                <div class="card-header d-flex dashed-line justify-content-between">
                                    ...
                                    <div class="kanan ">
                                        ...
                                        @if ($data->total_ampunt == $data->paid_amount && $data->status == 'dalam_proses')
                                        ...
                                        {{-- tampilan timeline apabila terbayar namun kurang, dan statusnya masih dalam proses --}}
                                        @if ($data->paid_amount > 0 && $data->status == 'dalam_proses' && $data->total_ampunt != $data->paid_amount)
                                            <div class="mt-3 d-flex ">
                                                <div data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                    data-bs-title="Pesanan ditambahkan"
                                                    data-bs-custom-class="custom-tooltip">
                                ...
                                <div class="card-body d-flex   row gap-0 justify-content-evenly">
                                    ...
                                    <div class=" col-4 p-0">
                                        <div class="card rounded-3">
                                            ...
                                            @if ($data->paid_amount == 0)
                                                <div class="card-header P-4 wajib-bayar custom-input"
                                                    ...
                                                    <h5 class="text-center fs-4  fzt7" style="font-weight: bold">Wajib
                                                        Bayar RP
                                                        {{ number_format($data->total_ampunt, 0, ',', '.') }}</h5>
                                                </div>
                                            @endif

                                            {{-- header ketika sudah terbayar sebagian --}}
                                            @if ($data->paid_amount < $data->total_ampunt && $data->paid_amount > 0)
                                                <div class="card-header P-4 wajib-bayar custom-input"
                                            ...
                                            @if ($data->paid_amount == $data->total_ampunt)
                                                <div class="card-header P-4 wajib-bayar custom-input"
                                                ...
                                                <table class="table table-borderless fw-bold fs-5 ">
                                                    <tr>
                                                        ...
                                                        <td class=" fzt7" id="total"
                                                            ...
                                                            {{ number_format($data->total_ampunt, 0, ',', '.') }}</td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table class="table table-borderless fw-bold">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class=" fzt7" id="kekurangan"
                                                            style="background-color: #EDEDED">RP
                                                            {{ number_format(max(0, $data->total_ampunt - $data->paid_amount), 0, ',', '.') }}
                                                        </td>
                                                    </tr>
                                                </table>

                                                {{-- status lunas muncul apabila sudah terbayar lunas --}}
                                                @if ($data->total_ampunt == $data->paid_amount)
                                                    <div id="status-lunas"
                                ...
                                <div class="col-12 row px-4 py-3">
                                  ...
                                  <div class="dropdown col-2">
                                      ...
                                      {{-- tombol pembayaran tidak bisa di klik apabila sudah terbayar lunas dan statusnya dalam proses --}}
                                      @if ($data->total_ampunt == $data->paid_amount && $data->status == 'dalam_proses')
                                      <button
