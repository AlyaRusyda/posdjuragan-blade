                        ...
                        @foreach ($orderan as $data)
                            <div id="maincard" class="card mt-5 rounded-3 custom-input ">
                                ...
                                <div class="card-header d-flex dashed-line  flex-row justify-content-between ">
                                    ...
                                    <!--card atas kanan-->
                                    @if ($data->paid_amount == 0 || ($data->paid_amount > 0 && $data->status == 'belum proses'))
                                ...
                                {{-- bawah khusus admin superadinL --}}
                                <div class="col-12 row px-4 py-3">
                                @if ($data->paid_amount >= 0 && $data->status == 'belum proses')
                                <button
                                class="rounded p-1 disabled-button justify-content-center flex-lg-row flex-md-column  col-lg-2  col-3"
