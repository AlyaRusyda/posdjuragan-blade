            ...
            <div class="col-xl-9  col-lg-10 col-md-11  mb-2 mt-5 bg-white border rounded">
                <div class="d-flex justify-content-start align-items-center">
                    ...
                    <div class="col p-0 text-start my-3 px-3">
                        <p class="mb-1 h5  text-capitalize" style="font-size: 28px; color:#41404C;">Yusuf Yeager</p>
                        <p class="mb-0 fw-light" style="font-size: 22px;  color:#5C6B82;">ID123456789</p>
                        <p class="mb-0 fs-6" style=" color:#5C6B82;"><span class="fs-6" style="color:#41404C; white-space:pre;">Hp 1       : </span> 089912345678</p>{{-- spasi sengaja diberikan --}}
                        <p class="mb-0 fs-6" style=" color:#5C6B82;"><span class="fs-6" style="color:#41404C; white-space:pre;">Hp 2      : </span>  087712345678</p>{{-- ganti dengan data tanpa menghapus spasi --}}
                        <p class="mb-0 fs-6" style=" color:#5C6B82; white-space:nowrap;"><span class="fs-6" style="color:#41404C; white-space:pre;">Email    : </span> uchihaDYeager@gmail.com</p>
                    </div>
                    <div class="col text-start align-self-start mt-3 px-3"style="max-width: 230px;">
                       <p class="mb-0 fs-4 " >Tgl. bergabung</p>
                       <p class="my-2" style="font-size: 22px; font-weight:300; color:#666666;">19/2/2001</p>
                       <span>
                        ...
                        <div class="d-flex justify-content-end mt-auto">
                            <button  class="btn btn-sm btn-outline-danger rounded-pill px-3 py-2 mx-2" data-bs-toggle="modal" data-bs-target="#modalEdit">Edit <i class="fa-solid fa-pen"></i></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-center bg-white" >
            <div class=" d-flex  gap-4 flex-column col-xl-9 col-lg-10 col-md-11 bg-white border rounded mt-2 p-4">
                <div class="d-flex gap-4 align-items-center ">
                    <a class="text-decoration-none" href="/superAdmin/dataPelanggan"><i class="fa-solid fa-arrow-left fs-4 color-title mb-0"></i></a><span class=" h4 color-title mb-0">Detail pelanggan</span>
                </div>
                <div class="d-flex flex-row justify-content-center px-lg-4 px-md-0 ">
                    ...
                    <div class="col-6">
                        <div class="d-flex flex-row mb-4">
                            <div class="col-6 px-2">
                                ...
                                <p class="fs-5 fw-light text-wrap mb-0">Jawa Tengah</p>
                            </div>
                            <div class="col-6 px-2">
                                <p class="mb-2 color-title h4" >Kab/Kota</p>
                                <p class="fs-5 fw-light text-wrap mb-0">Klaten</p>
                            </div>
                        </div>
                        <div class="d-flex flex-row mb-4">
                            <div class="col-6 px-2">
                                <p class="mb-2 color-title h4">Kecamatan</p>
                                <p class="fs-5 fw-light text-wrap mb-0">Polanharjo</p>
                            </div>
                            <div class="col-6 px-2">
                                <p class="mb-2 color-title h4">Kode Pos</p>
                                <p class="fs-5 fw-light text-wrap mb-0">123456</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6 px-2">
                        ...
                        <p class="fs-5 fw-light text-wrap mb-0">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptate ducimus atque voluptas deserunt corrupti sit officiis sapiente inventore fugit placeat.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="d-flex justify-content-center bg-white ">
            <a class="btn btn-blue my-4 px-4 py-2 " href="/superAdmin/riwayat">Riwayat Transaksi</a>
        </div>
    </div>
                    ...
                    <form action="" id="formDataPelanggan" >
                        ...
                        <div class="row d-flex">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select form-select-lg  shadow" id="kabupaten" name="kota" onchange="loadKecamatan()" required>
...
<script>
    ...
    function loadKecamatan() {
        ...
        var selectedKota = document.getElementById("kabupaten").value;
        if (selectedKota) {
