...
@section('konten')
    <div class="container-fluid p-4">
        <div class="bg-white ">
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <div class="col p-0 text-start my-3 px-3">
                            ...
                            <p class="mb-0 fs-6" style=" color:#5C6B82;"><span class="fs-6"
                                    style="color:#41404C; white-space:pre;">Hp 1 : </span>082212345678</p>
                            <p class="mb-0 fs-6" style=" color:#5C6B82;"><span class="fs-6"
                                    style="color:#41404C; white-space:pre;">Hp 2 : </span>082212345678</p>
                            <p class="mb-0 fs-6" style=" color:#5C6B82; white-space:nowrap;"><span class="fs-6"
                                    style="color:#41404C; white-space:pre;">Email : </span>sesuatu@gmail.com</p>
                        </div>
            ...
            <div class="d-flex justify-content-center bg-white">
                <div class="col-lg-10 col-xl-9 col-md-11  bg-white border rounded mt-2 mb-4  ">
                    <div class="mt-3 mb-4">
                        <span>
                            <a href="/superAdmin/detail" class="text-decoration-none ">
                    ...
                    <div class="d-flex flex-column m-3 gap-3">
                        <div class="d-flex justify-content-between "
                            ...
                            <div class="d-flex align-items-center justify-content-center gap-3 mx-4">
                                <a href="/superAdmin/invoice" class="btn btn-purple" style="font-size: 12px;">Lihat
                                    Invoice</a>
        ...
        {{-- modal tambah poin --}}
        <div class="modal fade" id="modalTambahPoin" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body mx-3 pt-0 ">
                        <div class="text-center mx-5">
                            <small class="text-danger">Setiap kelipatan Rp.100,000 daru transkasi mendapatkan 10 point
                                !</small>
                        </div>
                    ...
                    <div class="modal-footer border-top-0  justify-content-center mb-3">
                        <button type="button" class="btn btn-blue px-5" data-bs-dismiss="modal">Simpan</button>
                    </div>
                    </form>
                </div>
            </div>
