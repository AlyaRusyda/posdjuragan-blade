...
class AdminDataPelanggan extends Controller
{
    public function index(Customer $customer)
    {
        return view('admin.data-custom$customer.dataPelanggan', [
    ...
    public function show($id)
    {
        ...
        if (!$customer) {
            abort(404); // Handle jika custom$customer tidak ditemukan
        }

        return view('admin.data-pelanggan.detailPelanggan', ['title' => 'Detail Pelanggan'], compact('customer'));
    }
    ...
    public function edit($id)
    {
        ...
        // return view('admin.data-pelanggan.dataPelanggan', ['title' => 'Edit pelanggan'], compact('customer'));
    }
